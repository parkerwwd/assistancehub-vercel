            ...
            <div className="flex items-center gap-6">
              <div className="text-sm text-white/90 hidden sm:block">
                <div className="flex items-center gap-2">
                  ...
                  <span>Logged in as: <span className="font-semibold text-white">{user?.email}</span></span>
                </div>
              </div>
              <Button 
                variant="outline" 
                ...
                className="flex items-center gap-2 bg-white/10 border-white/30 text-white hover:bg-white/20 hover:border-white/40 transition-all duration-200"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-blue-50 to-indigo-50 hover:from-blue-100 hover:to-indigo-100">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-gray-700">Data Sources</CardTitle>
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-green-50 to-emerald-50 hover:from-green-100 hover:to-emerald-100">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-gray-700">Files Processed</CardTitle>
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-purple-50 to-violet-50 hover:from-purple-100 hover:to-violet-100">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-gray-700">Records Managed</CardTitle>
          ...
          <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-orange-50 to-amber-50 hover:from-orange-100 hover:to-amber-100">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <CardTitle className="text-sm font-semibold text-gray-700">Last Activity</CardTitle>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600">Manage and monitor HUD PHA database records</p>
              </div>
            </div>
            <PHADataManager />
          </div>

          {/* SNAP Data Section - Enhanced Placeholder */}
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600">Integration with USDA FNS data sources</p>
              </div>
            </div>
            <Card className="border-2 border-dashed border-gray-200 bg-gradient-to-br from-gray-50 to-green-50">
              <CardContent className="p-12">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">SNAP Data Management</h3>
                  <p className="text-gray-600 mb-2">Advanced integration with USDA Food and Nutrition Service</p>
                  <p className="text-sm text-gray-500">Coming soon with real-time sync capabilities</p>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600">Extended integrations and future capabilities</p>
              </div>
            </div>
              ...
              <Card className="border-2 border-dashed border-gray-200 bg-gradient-to-br from-gray-50 to-blue-50 hover:shadow-lg transition-shadow">
                <CardContent className="p-8">
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Housing Listings</h3>
                    <p className="text-gray-600 text-sm mb-2">Integration with housing listing APIs</p>
              ...
              <Card className="border-2 border-dashed border-gray-200 bg-gradient-to-br from-gray-50 to-purple-50 hover:shadow-lg transition-shadow">
                <CardContent className="p-8">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 text-sm mb-2">Real-time waitlist status updates</p>
        ...
        <div className="mt-16">
          <Card className="bg-gradient-to-r from-slate-50 to-gray-50 shadow-xl border-0">
            <CardHeader className="bg-gradient-to-r from-gray-900 to-slate-800 text-white rounded-t-xl">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="space-y-4">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-semibold text-gray-900 text-lg">Data Quality</h3>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-semibold text-gray-900 text-lg">Update Schedule</h3>
                  </div>
                  <ul className="space-y-3 text-sm text-gray-600">
                    <li className="flex items-center gap-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="font-semibold text-gray-900 text-lg">Data Sources</h3>
                  </div>
                  <ul className="space-y-3 text-sm text-gray-600">
                    <li className="flex items-center gap-2">
