...
const USMap: React.FC<USMapProps> = ({ onStateClick, selectedState }) => {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-6 shadow-lg">
      ...
      {/* Popular states buttons for easy access */}
      <div className="mt-6">
        <p className="text-center text-sm text-gray-600 mb-3">Popular states to explore:</p>
          ...
          {['06', '48', '12', '36', '17', '13'].map((stateId) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-1 px-3 py-1.5 bg-white rounded-lg border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-colors text-sm font-medium text-gray-700 hover:text-blue-700"
              >
