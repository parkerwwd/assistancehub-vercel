        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-amber-50 rounded-lg p-6 text-center">
            ...
            <p className="text-4xl font-bold text-gray-900">
              {property.year_put_in_service || 'N/A'}
            </p>
          </div>
          ...
          <div className="bg-amber-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-5 gap-4 text-center">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{property.units_studio || 0}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600 mb-2">1 Bed</p>
                <p className="text-2xl font-bold text-gray-900">{property.units_1br || 0}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600 mb-2">2 Bed</p>
                <p className="text-2xl font-bold text-gray-900">{property.units_2br || 0}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600 mb-2">3 Bed</p>
                <p className="text-2xl font-bold text-gray-900">{property.units_3br || 0}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-gray-600 mb-2">4 Bed</p>
                <p className="text-2xl font-bold text-gray-900">{property.units_4br || 0}</p>
              </div>
            </div>
