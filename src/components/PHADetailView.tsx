          ...
          <CardContent className="space-y-4">
              ...
              {office.combined_size_category && (
                <div className="p-3 bg-teal-50 rounded-lg border border-teal-100">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-medium text-gray-700">Size Category</span>
                  </div>
              ...
              {office.low_rent_size_category && (
                <div className="p-3 bg-orange-50 rounded-lg border border-orange-100">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-medium text-gray-700">Low Rent Size</span>
                  </div>
              ...
              {office.section8_size_category && (
                <div className="p-3 bg-pink-50 rounded-lg border border-pink-100">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs font-medium text-gray-700">Section 8 Size</span>
                  </div>
            ...
            {(office.total_units || office.total_dwelling_units || office.ph_occupied || office.section8_units_count || office.section8_occupied) && (
              <div className="space-y-3">
                <h4 className="font-medium text-gray-900 text-sm mb-3">Housing Units & Occupancy</h4>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  {office.total_dwelling_units && (
                    <div className="p-3 bg-green-50 rounded-lg border border-green-100 text-center">
                      ...
                      <div className="text-xs text-green-600 mt-1">Dwelling Units</div>
                    </div>
                  )}
                  ...
                  {office.ph_occupied && (
                    <div className="p-3 bg-purple-50 rounded-lg border border-purple-100 text-center">
                      ...
                      <div className="text-xs text-purple-600 mt-1">PH Occupied</div>
                    </div>
                  )}
                  ...
                  {office.section8_units_count && (
                    <div className="p-3 bg-orange-50 rounded-lg border border-orange-100 text-center">
                      ...
                      <div className="text-xs text-orange-600 mt-1">Section 8 Units</div>
                    </div>
                  )}
                  ...
                  {office.section8_occupied && (
                    <div className="p-3 bg-red-50 rounded-lg border border-red-100 text-center">
                      ...
                      <div className="text-xs text-red-600 mt-1">Section 8 Occupied</div>
                    </div>
                  )}
                </div>
              </div>
            ...
            {office.jurisdictions && office.jurisdictions.length > 0 && (
              <div className="pt-3 border-t border-gray-100">
                <h4 className="font-medium text-gray-900 mb-3 text-sm">Service Areas</h4>
